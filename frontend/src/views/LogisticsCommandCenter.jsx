// Manufacturer Logistics Command Center — mission control for inventory,
// shipments, transfers, fleet and demand intelligence.
// Route: /manufacturer/logistics-center
import { useCallback, useEffect, useRef, useState } from "react";
import { useNavigate } from "react-router-dom";
import {
  Boxes, Warehouse, ClipboardList, Truck, Clock4, Banknote, Gauge,
  RefreshCw, Satellite,
} from "lucide-react";
...
import { AlertsPanel, QuickActionsPanel, PipelinePanel, ForecastPanel } from "./logistics/LogisticsPanels";
import {
  AllocationPanel, AuthorizationPanel, TransfersPanel, CreateTransferDialog,
} from "./logistics/LogisticsActionPanels";
    ...
    return (
      <div className="p-8 grid place-items-center min-h-[60vh] text-slate-400 text-sm" data-testid="logistics-loading">
        <div className="flex items-center gap-2">
          <RefreshCw className="h-4 w-4 animate-spin" /> Loading Logistics Command Center…
        </div>
      </div>
    );
  }
