...
export const ShipmentsTable = ({ shipments = [], onTrack }) => {
        ...
        <table className="w-full text-left">
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              <tr key={s.id} className="border-t border-slate-800/60 hover:bg-slate-800/30 transition-colors" data-testid="shipment-row">
