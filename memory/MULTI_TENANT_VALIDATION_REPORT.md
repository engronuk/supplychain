...
| # | Test | Result | Detail |
|---:|---|:---:|---|
| 1 | super_admin sees both tenants | ✅ | uni=3206 flour=9 |
...
| 8 | Unilever [manufacturer] cannot see any Flour Mills org | ✅ | count=3206 flour_overlap=0 |
| 9 | Unilever [distributor] cannot see any Flour Mills org | ✅ | count=196 flour_overlap=0 |
...
| 22 | Super-admin descendant query on Unilever root still works | ✅ | size=3206 expected=3206 |
