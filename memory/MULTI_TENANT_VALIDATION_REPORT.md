...
| # | Test | Result | Detail |
|---:|---|:---:|---|
| 1 | super_admin sees both tenants | ✅ | uni=3205 flour=9 |
...
| 8 | Unilever [manufacturer] cannot see any Flour Mills org | ✅ | count=3205 flour_overlap=0 |
| 9 | Unilever [distributor] cannot see any Flour Mills org | ✅ | count=195 flour_overlap=0 |
...
| 22 | Super-admin descendant query on Unilever root still works | ✅ | size=3205 expected=3205 |
